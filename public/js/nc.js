...
(function () {
  ...
  nc.slider = function (owlObj) {
    ...
    var config = {
      ...
      res: o.attr("data-itemrange")
        ? nc.owlitems(o.attr("data-itemrange"))
        : resObj,
    ...
    o.animate({ opacity: 1 }, 300, function () {
      if (owlEle.find(".owl-stage").length === 0) {
        owlEle.owlCarousel({
          ...
          loop:
            $(owlObj + " .owl-carousel > .item").length > 1
              ? config.loop
              : false,
        ...
        .on("click", function (e) {
          ...
          var tb_activeClass = $(obj).attr("data-tb-active")
            ...
            pn_activeClass = $(obj).attr("data-pn-active")
              ...
              : "active",
            tb_normalClass = $(obj).attr("data-tb-normal")
              ? $(obj).attr("data-tb-normal")
              : "",
            pn_normalClass = $(obj).attr("data-pn-normal")
              ? $(obj).attr("data-pn-normal")
              : "";
    ...
    $form
      ...
      .on("click", function (e) {
        ...
        if (config.form_type == "newsletter") {
          nc.global_validation.successMsg =
            nc.global_validation.subscribe_successMsg;
        } else {
          nc.global_validation.successMsg =
            nc.global_validation.form_successMsg;
        }
  ...
  nc.instagram = function (obj) {
    ...
    o.find(".feed-data").socialfeed({
      instagram: {
        ...
        tpl_class: o.attr("data-insta-tplclass")
          ? o.attr("data-insta-tplclass")
          : "",
      },

      // GENERAL SETTINGS
      template: "lib/social-feed/" + o.attr("data-insta-tpl") + ".html",
      length: o.attr("data-insta-length")
        ? parseInt(o.attr("data-insta-length"), 10)
        : 256,
      show_media: true,
      update_period: false,
  ...
  nc.twitter = function (obj) {
    ...
    o.find(".feed-data").socialfeed({
      twitter: {
        ...
        tpl_class: o.attr("data-twitter-tplclass")
          ? o.attr("data-twitter-tplclass")
          : "",
        tpl_class1: o.attr("data-twitter-tplclass1")
          ? o.attr("data-twitter-tplclass1")
          : "",
        tpl_class2: o.attr("data-twitter-tplclass2")
          ? o.attr("data-twitter-tplclass2")
          : "",
        tpl_class3: o.attr("data-twitter-tplclass3")
          ? o.attr("data-twitter-tplclass3")
          : "",
        tpl_class4: o.attr("data-twitter-tplclass4")
          ? o.attr("data-twitter-tplclass4")
          : "",
      },

      // GENERAL SETTINGS
      template: "lib/social-feed/" + o.attr("data-twitter-tpl") + ".html",
      length: o.attr("data-twitter-length")
        ? parseInt(o.attr("data-twitter-length"), 10)
        : 256,
      show_media: true,
      update_period: false,
  ...
  //$("#config_style").attr('href', 'css/configstyle.css?' + nc.uid());
  ...
  nc.init = function () {
    ...
    $o.navwrp =
      $(".nc-navigation").length > 0 && $o.r ? $(".nc-navigation") : false;
    $o.navlink =
      $(".nc-navigation").find(".nc-navigation--ul").length > 0 && $o.r
        ? $o.navwrp.find(".nc-navigation--ul")
        : false;
    $o.fullwh =
      $("[data-fullwh='y']").length > 0 && $o.r
        ? $("[data-fullwh='y']")
        : false;
    $o.fullh =
      $("[data-fullh='y']").length > 0 && $o.r ? $("[data-fullh='y']") : false;
    $o.bg = $("[data-bg]").length > 0 && $o.r ? $("[data-bg]") : false;
    $o.hoverclass =
      $("[data-hover-class]").length > 0 && $o.r
        ? $("[data-hover-class]")
        : false;
    $o.bgcolor =
      $("[data-bgcolor]").length > 0 && $o.r ? $("[data-bgcolor]") : false;
    $o.txtcolor =
      $("[data-txtcolor]").length > 0 && $o.r ? $("[data-txtcolor]") : false;
    $o.gradient =
      $("[data-gradient]").length > 0 && $o.r ? $("[data-gradient]") : false;
    $o.videopop =
      $(".video-popup").length > 0 && $o.r ? $(".video-popup") : false;
    $o.setpop = $(".set-popup").length > 0 && $o.r ? $(".set-popup") : false;
    $o.countbox = $(".count-box").length > 0 && $o.r ? $(".count-box") : false;
    $o.tabwidget =
      $(".tab-widget").length > 0 && $o.r ? $(".tab-widget") : false;
    $o.tabsauto = $(".tabs-auto").length > 0 && $o.r ? $(".tabs-auto") : false;
    $o.carouselwidget =
      $(".carousel-widget").length > 0 && $o.r ? $(".carousel-widget") : false;
    $o.accordionwidget =
      $(".accordion-widget").length > 0 && $o.r
        ? $(".accordion-widget")
        : false;
    $o.swiperwidget =
      $(".swiper-widget").length > 0 && $o.r ? $(".swiper-widget") : false;
    $o.swipergallery =
      $(".swiper-gallery").length > 0 && $o.r ? $(".swiper-gallery") : false;
    $o.videobg = $(".videobg").length > 0 && $o.r ? $(".videobg") : false;
    $o.videwidget =
      $(".vide-widget").length > 0 && $o.r ? $(".vide-widget") : false;
    $o.othersection1 =
      $(".other-section-1").length > 0 && $o.r ? $(".other-section-1") : false;
    $o.popgallerywidget =
      $(".popgallery-widget").length > 0 && $o.r
        ? $(".popgallery-widget")
        : false;
    $o.bgslider =
      $("[data-bgslider]").length > 0 && $o.r ? $("[data-bgslider]") : false;
    $o.kbgslider =
      $("[data-kbgslider]").length > 0 && $o.r ? $("[data-kbgslider]") : false;
    $o.countdownwidget =
      $(".countdown-widget").length > 0 && $o.r
        ? $(".countdown-widget")
        : false;
    $o.filterwidget =
      $(".filter-widget").length > 0 && $o.r ? $(".filter-widget") : false;
    $o.gmapwidget =
      $(".gmap-widget").length > 0 && $o.r ? $(".gmap-widget") : false;
    $o.socialsection =
      $(".social-section").length > 0 && $o.r ? $(".social-section") : false;
    $o.instagramwidget =
      $(".instagram-widget").length > 0 && $o.r
        ? $(".instagram-widget")
        : false;
    $o.twitterwidget =
      $(".twitter-widget").length > 0 && $o.r ? $(".twitter-widget") : false;
    $o.formwidget =
      $(".form-widget").length > 0 && $o.r ? $(".form-widget") : false;
    $o.stellar =
      $("[data-stellar]").length > 0 && $o.r ? $("[data-stellar]") : false;
    $o.elanimate =
      $("[data-animate-in]").length > 0 && $o.r
        ? $("[data-animate-in]")
        : false;
    $o.bLazy = $(".b-lazy").length > 0 && $o.r ? $(".b-lazy") : false;
    $o.masonry =
      $("[data-masonry]").length > 0 && $o.r ? $("[data-masonry]") : false;
    $o.ncajax =
      $("#nc-ajaxpage").length > 0 && $o.r ? $("#nc-ajaxpage") : false;

    $o.styleid =
      $("[data-style-id]").length > 0 && $o.r ? $("[data-style-id]") : false;
    ...
    if ($o.bg) {
      for (var i = 0; i < $o.bg.length; i++) {
        $($o.bg[i]).css({
          backgroundImage: "url(" + $($o.bg[i]).attr("data-bg") + ")",
        });
      }
    }
    if ($o.bgcolor) {
      ...
      for (var i = 0; i < $o.elanimate.length; i++) {
        var animateobj = $($o.elanimate[i]),
          ...
          animatearr =
            animatein.indexOf("|") > -1 ? animatein.split("|") : animatein,
          animateclass =
            typeof animatearr == "object" ? animatearr[0] : animatearr,
    ...
    if ($o.videobg) {
      var mbyt_script_arr = [
        "lib/jquery.mb.YTPlayer/jquery.mb.YTPlayer.min.js",
      ];
    ...
    if ($o.socialsection) {
      ...
      nc.getMultiScripts(social_script_arr, "lib/social-feed/").done(
        function () {
          // TWITTER
          if ($o.twitterwidget) {
    ...
    enquire
      ...
      .register("(min-width: 200px) and (max-width: 991px)", {
        ...
        unmatch: function () {
          $(".nav-wrp").attr("data-glass") === "y"
            ? $(".nav-wrp").addClass("bg-glass")
            : null;
          $(".nav-wrp").attr("data-above") === "y"
            ? $(".nav-wrp").addClass("show-above")
            : null;
        },
      });
  ...
  jQuery(document).ready(function ($) {
    ...
    // $o.r = !nc.demo ? false : nc.demo();
    // $o.tooltip = $o.r ? $('[data-toggle="tooltip"]') : false;
    // $o.navwrp = $('.nc-navigation').length > 0 && $o.r ? $('.nc-navigation') : false;
    // $o.navlink = $('.nc-navigation').find(".nc-navigation--ul").length > 0 && $o.r ? $o.navwrp.find(".nc-navigation--ul") : false;
    ...
    // $o.ncajax = $("#nc-ajaxpage").length > 0 && $o.r ? $("#nc-ajaxpage") : false;
    ...
    if ($o.r) {
      ...
      Pace.on("done", function () {
        nc.animationIn(".nc-main--pagewrapper");
      });

      /*----------  NAVIGATION  ----------*/
      if ($o.navlink) {
        $(".nc-menutrigger").on("click", function (event) {
          event.preventDefault();
          toggleNav(true);
        });
        $(".nc-navigation--close, .nc-main--pageoverlay").on(
          "click",
          function (event) {
            event.preventDefault();
            toggleNav(false);
        ...
        $(".nc-pagelink").on("click", function (event) {
          toggleNav(false);
          $(".nc-menu li").removeClass("nc-active");
          $(this).addClass("nc-active");
        });
        function toggleNav(bool) {
          $(".nc-navigation, .nc-main--pageoverlay").toggleClass(
            "visible-on",
            bool
          );
          $("#nc-main").toggleClass("nc-down-scale", bool);
        }
      }

      /*----------  PAGE TRANSATION  ----------*/
      if ($o.ncajax) {
        $(".nc-pagelink").on("click", function () {
          var ncPageObj = {
            ncMainPageWrapper: ".nc-main--pagewrapper",
            ncPageType: $(this).attr("data-pgtype"),
            ncPageUrl: $(this).attr("data-ncpage"),
            ncAjaxPage: "#nc-ajaxpage",

            displayHidden: function (area) {
              $(ncPageObj.ncMainPageWrapper + " " + area).addClass("hidden");
            },
            displayVisible: function (area) {
              $(ncPageObj.ncMainPageWrapper + " " + area).removeClass("hidden");
            },
            pageLoad: function () {
              // $.get(ncPageObj.ncPageUrl, function (data, response) {
              //   $(ncPageObj.ncAjaxPage).html(" ");
              //   $(ncPageObj.ncAjaxPage).html(data);
              // });

              $o = nc.init();
              nc.animationIn(ncPageObj.ncMainPageWrapper);
              if ($(ncPageObj.ncAjaxPage).find(".clock").length == 0) {
            ...
            homeLoad: function () {
              $.get(ncPageObj.ncPageUrl, function (data) {
                $(ncPageObj.ncAjaxPage).html(" ");
              });

              $("#home-page").removeClass("op-0");
              nc.animationIn(ncPageObj.mainWrapper);
              if ($(ncPageObj.ncAjaxPage).find(".clock").length == 0) {
                if (typeof e !== "undefined") {
                  e.doCountDown = function () {};
                  t = "";
          ...
          if (ncPageObj.ncPageType == "intropage") {
            nc.animationOut(ncPageObj.ncMainPageWrapper);
            setTimeout(function () {
              $(ncPageObj.ncMainPageWrapper).removeClass("nc-activeajax");
              $(ncPageObj.ncMainPageWrapper).addClass("nc-activeintro");
              nc.animationIn(ncPageObj.ncMainPageWrapper);
              ncPageObj.homeLoad();
            }, 900);
          } else {
            $(ncPageObj.ncMainPageWrapper).addClass("nc-activeajax");

            nc.animationOut(ncPageObj.ncMainPageWrapper);
            setTimeout(function () {
              $(ncPageObj.ncMainPageWrapper).removeClass("nc-activeintro");
              ncPageObj.pageLoad();
            }, 900);
          }
        });
